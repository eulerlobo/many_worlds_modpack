...
//OpenBlocs Scaffolding conflict with More Buttons
...
//mods.thermalexpansion.Pulverizer.removeRecipe(<ore:oreAmethyst>);
//mods.thermalexpansion.Pulverizer.removeRecipe(<netherex:amethyst_ore>);
